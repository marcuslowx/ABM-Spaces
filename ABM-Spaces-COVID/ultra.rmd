...
NCTI_inf_2_l <- quantile(t2x$Infections, probs =0.025)
NCTI_inf_2_h <- quantile(t2x$Infections, probs =0.975)
CTIW_inf_2_l <- quantile(t2$Infections, probs =0.025)
CTIW_inf_2_h <- quantile(t2$Infections, probs =0.975)
CTIN_inf_2_l <- quantile(t2n$Infections, probs =0.025)
CTIN_inf_2_h <- quantile(t2n$Infections, probs =0.975)

NCTI_inf_8_l <- quantile(t8x$Infections, probs =0.025)
NCTI_inf_8_h <- quantile(t8x$Infections, probs =0.975)
CTIW_inf_8_l <- quantile(t8$Infections, probs =0.025)
CTIW_inf_8_h <- quantile(t8$Infections, probs =0.975)
CTIN_inf_8_l <- quantile(t8n$Infections, probs =0.025)
CTIN_inf_8_h <- quantile(t8n$Infections, probs =0.975)

NCTI_dead_2_l <- quantile(t2x$Dead, probs =0.025)
NCTI_dead_2_h <- quantile(t2x$Dead, probs =0.975)
CTIW_dead_2_l <- quantile(t2$Dead, probs =0.025)
CTIW_dead_2_h <- quantile(t2$Dead, probs =0.975)
CTIN_dead_2_l <- quantile(t2n$Dead, probs =0.025)
CTIN_dead_2_h <- quantile(t2n$Dead, probs =0.975)

NCTI_dead_8_l <- quantile(t8x$Dead, probs =0.025)
NCTI_dead_8_h <- quantile(t8x$Dead, probs =0.975)
CTIW_dead_8_l <- quantile(t8$Dead, probs =0.025)
CTIW_dead_8_h <- quantile(t8$Dead, probs =0.975)
CTIN_dead_8_l <- quantile(t8n$Dead, probs =0.025)
CTIN_dead_8_h <- quantile(t8n$Dead, probs =0.975)

NCTI_test_2_l <- quantile(t2x$Tests, probs =0.025)
NCTI_test_2_h <- quantile(t2x$Tests, probs =0.975)
CTIW_test_2_l <- quantile(t2$Tests, probs =0.025)
CTIW_test_2_h <- quantile(t2$Tests, probs =0.975)
CTIN_test_2_l <- quantile(t2n$Tests, probs =0.025)
CTIN_test_2_h <- quantile(t2n$Tests, probs =0.975)

```

# Some important 95% uncertainty ranges

Infections and TAT = 2:

No CTI `r NCTI_inf_2_l` `r NCTI_inf_2_h`

CTI with testing `r CTIW_inf_2_l` `r CTIW_inf_2_h`

CTI without testing `r CTIN_inf_2_l` `r CTIN_inf_2_h`

Deaths and TAT = 2:

No CTI `r NCTI_dead_2_l` `r NCTI_dead_2_h`

CTI with testing `r CTIW_dead_2_l` `r CTIW_dead_2_h`

CTI without testing `r CTIN_dead_2_l` `r CTIN_dead_2_h`

Number of tests and TAT = 2:

No CTI `r NCTI_test_2_l` `r NCTI_test_2_h`

CTI with testing `r CTIW_test_2_l` `r CTIW_test_2_h`

CTI without testing `r CTIN_test_2_l` `r CTIN_test_2_h`

Infections and TAT = 8:

No CTI `r NCTI_inf_8_l` `r NCTI_inf_8_h`

CTI with testing `r CTIW_inf_8_l` `r CTIW_inf_8_h`

CTI without testing `r CTIN_inf_8_l` `r CTIN_inf_8_h`

Deaths and TAT = 8:

No CTI `r NCTI_dead_8_l` `r NCTI_dead_8_h`

CTI with testing `r CTIW_dead_8_l` `r CTIW_dead_8_h`

CTI without testing `r CTIN_dead_8_l` `r CTIN_dead_8_h`
...
library(reshape2)
a_graph <- select(k, TaT, Infections_no_cti, Infections_cti_test, Infections_cti_no_test)
colnames(a_graph) <- c("TaT", "No CTI", "CTI with test", "CTI without test")
a_graph <- reshape2::melt(a_graph, id.vars = "TaT")
ggplot(data = a_graph, aes(x = TaT, y = value, colour = variable)) +
geom_line() +
...
a_graph <- select(k, TaT, Dead_no_cti, Dead_cti_test, Dead_cti_no_test)
colnames(a_graph) <- c("TaT", "No CTI", "CTI with test", "CTI without test")
a_graph <- reshape2::melt(a_graph, id.vars = "TaT")
ggplot(data = a_graph, aes(x = TaT, y = value, colour = variable)) +
geom_line() +
...
a_graph <- select(k, TaT, Tests_no_cti, Tests_cti_test, Tests_cti_no_test)
colnames(a_graph) <- c("TaT", "No CTI", "CTI with test", "CTI without test")
a_graph <- reshape2::melt(a_graph, id.vars = "TaT")
ggplot(data = a_graph, aes(x = TaT, y = value, colour = variable)) +
geom_line() +
