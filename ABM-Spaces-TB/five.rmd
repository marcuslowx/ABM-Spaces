...
ggplot(data = curves, mapping = aes(x = year)) +
  ...
  geom_line(aes(y = Scenario2), color = "red") +
  geom_line(aes(y = Scenario3), color = "orange") +
  geom_line(aes(y = Scenario4), color = "green") +
  geom_line(aes(y = Scenario5), color = "blue") +
 labs(x = "Years", y = "Active cases/100k", title ="Active TB cases/100k over time") +
  scale_fill_discrete(labels=c("Base scenario", "Base + CTI", "Mass X-ray + CTI", "TUT + CTI", "Ultra + CTI")) +
  theme_gray()
ggsave("fig3.png")
```
